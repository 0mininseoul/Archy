...
⚠️ 주의: "(제목)", "(핵심 1)" 같은 플레이스홀더를 그대로 출력하지 마세요. 반드시 녹취록 기반의 실제 내용을 작성하세요.`;
...
⚠️ 주의: "(제목)", "(있는 내용만 정리)" 같은 플레이스홀더를 그대로 출력하지 마세요.`;
...
⚠️ 주의: "(짧은 제목)" 같은 플레이스홀더를 그대로 출력하지 마세요.`;
